...
- [`coords_to_address()`](https://frbcesab.github.io/rutils/reference/coords_to_address.html): retrieve any location in the World from geographic coordinates
...
- [`hiking_time()`](https://frbcesab.github.io/rutils/reference/hiking_time.html): Hiking time calculation

- [`get_city_admin_info()`](https://frbcesab.github.io/rutils/reference/get_city_admin_info.html): Retrieve administrative information of a French city (postal code, INSEE code, region, etc.)
